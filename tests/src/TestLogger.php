...
class TestLogger implements LoggerInterface
{
    ...
    protected function isSystemQuery(string $query): bool
    {
        return \str_contains($query, 'constraint_name') || \str_contains($query, '_migrations') || \str_contains($query, 'information_schema') || \str_contains($query, 'table status');
    }
